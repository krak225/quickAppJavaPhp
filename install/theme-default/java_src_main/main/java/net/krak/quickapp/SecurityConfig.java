...
import net.krak.quickapp.filters.JwtAuthenticationFilter;
import net.krak.quickapp.filters.JwtAutorizationFilter;
import net.krak.quickapp.services.UserDetailsServiceImpl;
